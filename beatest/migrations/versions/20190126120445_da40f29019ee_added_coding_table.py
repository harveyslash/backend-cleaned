"""added coding languages table

Revision ID: da40f29019ee
Revises: 495e775f0ff7
Create Date: 2019-01-26 12:04:45.877765+00:00
...
revision = 'da40f29019ee'
down_revision = '495e775f0ff7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('coding_language',
    ...
    coding_ad_hoc_table = table('coding_language',
                                column('id', Integer),
                                column('name', String),
                                )
