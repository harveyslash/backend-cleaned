def get_research_ability(test_attempt_query):
    research_ability_scores = []
    difficulty_scores = []
    was_correct_vals = []
    for section_attempt in test_attempt_query['section_attempts']:
        for question_attempt in section_attempt['question_attempts']:
            ...
            research_ability_scores.append(anal_value)
    ...
    for anal_value, difficulty_score, was_correct in zip(
            research_ability_scores, difficulty_scores, was_correct_vals):
